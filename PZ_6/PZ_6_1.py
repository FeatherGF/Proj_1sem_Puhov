...
sr_arif, counter = 0, 0
print(f'Среднее арифметическое: {sum(my_list[k - 1:L]) / len(my_list[k - 1:L])}')  # вычисление суммы элементов списка
# на срезе от K до L включительно. Затем деление на длину списка с таким же срезом.
